...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        print("\n@@@ operacao falhou! voce nao tem saldol suficiente. @@@")

    elif excedeu_limite:
        print("\n@@@ operacao falhou! o valor do saque excedeu o limite de saque. @@@")
...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    print("\n@@@ usuario nao encontrado, fluxo de conta encerrado! @@@")
